 ...
 */
public class GunnahExam extends Fragment {
    ...
    String[] multipleQuestion = {
            ...
            "তানভিন কাকে বলে ? ",
            "মীমে সাকিন কাকে বলে ? ",
            "নুনে সাকিন ও তানভিন কয় প্রকারে পড়া যায় ?",
            "মীমে সাকিন কয় প্রকারে পড়া যায় ?",
            " ইক্লাবের হরফ কয়টি ?",
            " ইযহারে খাস এর হরফ কয় টি ?",
            "ইদ্গমের হরফ কয়টি ?",
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_gunnah_exam, container, false);
        ...
        your_marks_gunnah = view.findViewById(R.id.your_marks_gunnah);
        ...
        RootRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    your_marks_gunnah.setText(retreveGunnahMarks);
                }
            }
            ...
            public void onClick(View v) {
                ...
                RootRef.child(currentUserID).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        RootRef.child("GunnahExam").setValue(your_marks_gunnah.getText().toString());
                ...
                if((position<multipleQuestion.length-1)){
                    ...
                    if (SelectTV.equals(mcq_answer) && sentanceOnee.equals(sentenceTwoo)) {
                        ...
                        your_marks_gunnah.setText(""+current_marks);
                        goodToast.start();
