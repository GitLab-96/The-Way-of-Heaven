 ...
 */
public class AllahExam extends Fragment {
    ...
    String[] multipleQuestion = {
            " কখন 'الله'মোটা করিয়া পড়িতে হয় ?",
            " কখন 'الله'চিকন করিয়া পড়িতে হয় ? ",
            " আল্লাহ শব্দের লামের তাশদিদের ডানে যবর থাকিলে কি করিয়া পড়িতে হয় ? ",
            " আল্লাহ শব্দের লামের তাশদিদের ডানে যের থাকিলে কি করিয়া পড়িতে হয়  ?",
            " আল্লাহ শব্দের লামের তাশদিদের ডানে পেশ থাকিলে কি করিয়া পড়িতে হয় ?",
            " ামাদের সৃষ্টিকর্তা কে ?",
            " । 'ر' শব্দতা কি করিয়া পড়িতে হয় ?",
            "। 'ر' শব্দতা কি করিয়া পড়িতে হয়  ?",
            " কুরআন কার বাণী ?",
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_allah_exam, container, false);
        ...
        your_marks_allah = view.findViewById(R.id.your_marks_allah);
        ...
        RootRef= FirebaseDatabase.getInstance().getReference("Marks");  mAuth=FirebaseAuth.getInstance();
        currentUserID= mAuth.getCurrentUser().getUid();
        ...
        RootRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    your_marks_allah.setText(retreveAllahMarks);
                }
            }
            ...
            public void onClick(View v) {
                ...
                RootRef.child(currentUserID).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        RootRef.child("AllahExam").setValue(your_marks_allah.getText().toString());
                ...
                if((position<multipleQuestion.length-1)){
                    ...
                    if (SelectTV.equals(mcq_answer) && sentanceOnee.equals(sentenceTwoo)) {
                        ...
                        your_marks_allah.setText(""+current_marks);
                        goodToast.start();
